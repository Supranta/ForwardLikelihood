...
class simple_distance(fwd_lkl):
    def __init__(self, v_data, v_field, delta_field, coord_system, vary_sig_v, add_monopole, add_quadrupole, start_index, rescale_distance, add_sigma_int, lognormal, N_POINTS=500):
