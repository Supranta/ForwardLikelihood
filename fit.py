...
N_FLOW_PARAMS = num_flow_params(vary_sig_v, add_monopole)
N = N_FLOW_PARAMS
theta_init_mean, theta_init_spread, flow_model_labels, simple_labels = flow_params_pos0(vary_sig_v, add_monopole)
...
for i, catalog in enumerate(catalogs):
        ...
        obj = create_catalog_obj(v_data_type, v_data_file,\
            N, vary_sig_v, add_monopole, v_field, delta_field, coord_system, lognormal, rescale_distance, add_sigma_int)
