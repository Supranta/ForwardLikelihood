...
for i, catalog in enumerate(catalogs):
        v_data_type, rescale_distance, add_sigma_int, fix_sigma_int, v_data_file, lognormal = catalog
        obj = create_catalog_obj(v_data_type, v_data_file,\
            N, vary_sig_v, v_field, delta_field, coord_system, lognormal, rescale_distance, add_sigma_int, fix_sigma_int)
